...
CommandLine.Parser.Default.ParseArguments<Configuration>(args)
    .WithParsed(c =>
    {
        ...
        switch
        {
            "euclidean" => "euclidean",
            "manhattan" => "manhattan",
            "delegate_euclidean" => "delegate_euclidean",
            "delegate_manhattan" => "delegate_manhattan",
            _ => "euclidean",
        };
    }).WithNotParsed(c =>
    {
    ...
    switch
{
    ...
    "delegate_euclidean" => new DelegateClassifier("Euclidean Classifier", training, Distances.EuclideanDistance),
    "delegate_manhattan" => new DelegateClassifier("Manhattan Classifier", training, Distances.ManhattanDistance),
